...
public class OrderServiceImpl implements IOrderService {
    ...
    @Override
    public ServerResponse pay(Integer userIf, Long orderNo) {
        //step1:参数非空校验
        if (orderNo == null) {
    ...
    public ServerResponse pay(Order order) throws IOException {
        ...
        String body = "购买商品" + order.getPayment() + "元";
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://39.105.149.25:8080/order/alipay_callback.do")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
                .setGoodsDetailList(goodsDetailList);
        // http://zucdnf.natappfree.cc/order/alipay_callback.do
